...
const urlImg = '/img/posts/kanareikin/';
...
export default {
    ...
    html: `<p> Задача: разработать запоминающийся брендинг для кофейни с четкой геометрией форм.</p>
           ...
           <img class="img--full mt-30" loading="lazy" src="${urlImg}main.jpg" alt="'Не усложняй' - логотип" />
           <div class="bl-half">
                <img class="img--full mt-30" loading="lazy" src="${urlImg}half-1.jpg" srcset="${urlImg}half-1@2x.jpg 2x" alt="Патч на футболку 'Не усложняй'" />
           ...
           <div class="bl-half">
                ...
                <img class="img--full mt-30" loading="lazy" src="${urlImg}half-2.jpg" srcset="${urlImg}half-2@2x.jpg 2x" alt="Патч на футболку 'Не усложняй'" />
           </div>
           
           <img class="img--full mt-30" loading="lazy"  src="${urlImg}stikers.jpg" alt="Патч на футболку 'Не усложняй' Вариант 2" />
           <p class="mt-30" style="text-align: center"> Применение логотипа на разлинных носителях</p>
           <div class="bl-tr mt-30">
